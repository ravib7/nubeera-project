...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">Git</h1>
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-2">
										<img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">G </span>
									<!--//card-icon-holder-->
                           ...
                           Introduction to Git
								...
								<a class="card-link-mask" href="01GettingStarted/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
							...
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
										<img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">GB
									</span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Git Basics</span>
								</h5>
								<div class="card-text">
                           Basics of Git
								</div>
								<a class="card-link-mask" href="02GitBasics/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
						...
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									...
									<!--//card-icon-holder-->
									<span class="card-title-text">Git Branching</span>
								</h5>
								<div class="card-text">
									Branching in Git
								</div>
								<a class="card-link-mask" href="03/GitBranching/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
               ...
               <div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
                              <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">DG</span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Distributed Git</span>
								</h5>
								<div class="card-text">
									Git Distributed
								</div>
								<a class="card-link-mask" href="04DistributedGit/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
               ...
               <div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
                              <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">GH</span>
									<!--//card-icon-holder-->
								...
								<a class="card-link-mask" href="05GitHub/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
               ...
               <div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
                              <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">GS</span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Git and other Systems</span>
								</h5>
								<div class="card-text">
									Companions of Git
								</div>
								<a class="card-link-mask" href="06GitandOtherSystems/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
