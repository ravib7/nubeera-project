...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">Core Base Module</h1>
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<div class="card-text">
                           Scripting / Programming Language / AI / Cloud / Automation
								</div>
								<a class="card-link-mask" href="python/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
							...
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
										<img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">L
									</span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Linux</span>
								</h5>
								<div class="card-text">
                           97% of industries use Linux Operating system
								</div>
								<a class="card-link-mask" href="linux/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
               ...
               <div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
										<img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">G
									</span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Git</span>
								</h5>
								<div class="card-text">
                           Microsoft, Google, Apple, Facebook are some of major companies that uses Git
								</div>
								<a class="card-link-mask" href="git/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
						...
						<div class="card shadow-sm">
							<div class="card-body">
                              ...
                              <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">S</span>
								...
								<div class="card-text">
                           One of the most preferred DBMS Query Language
								</div>
