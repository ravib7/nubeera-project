...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">Python Materials</h1>
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="presentations/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
						...
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									...
									<!--//card-icon-holder-->
									<span class="card-title-text">Cloud(Boto3)</span>
								</h5>
								<div class="card-text">
									Boto3 using Python
								</div>
								<a class="card-link-mask" href="cloud(boto3)/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
