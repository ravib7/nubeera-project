...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">For Loop in Python</h1>
	...
	<div class="container">
		...
		A <code>for</code> loop is used for iterating over a sequence (that is either a list, a tuple, a dictionary, a set, or a string).<br><br>
		This is less like the <code>for</code> keyword in other programming languages, and works more like an iterator method as found in other object-orientated programming languages.<br><br>
		With the <code>for</code> loop we can execute a set of statements, once for each item in a list, tuple, set etc.<br><br>
		The <code>for</code> loop does not require an indexing variable to set beforehand.<br>
		...
		With the <code>break</code> statement we can stop the loop before it has looped through all the items<br><br>
		...
		To loop through a set of code a specified number of times, we can use the <code>range()</code> function,<br><br>
		The <code>range()</code> function returns a sequence of numbers, starting from 0 by default, and increments by 1 (by default), and ends at a specified number.<br><br>
		The <code>range()</code> function defaults to 0 as a starting value, however it is possible to specify the starting value by adding a parameter: <br><code>range(2, 6)</code>, which means values from 2 to 6 (but not including 6).<br><br>

		The <code>range()</code> function defaults to increment the sequence by 1, however it is possible to specify the increment value by adding a third parameter: <code>range(2, 30, 3).</code><br>
		...
		<h3>Nested Loops</h3>
		A nested loop is a loop inside a loop.<br><br>
		The "inner loop" will be executed one time for each iteration of the "outer loop"<br>
		<h3>The pass Statement</h3>
		<code>for</code> loops cannot be empty, but if you for some reason have a <code>for</code> loop with no content, put in the<code> pass </code>statement to avoid getting an error.<br>
