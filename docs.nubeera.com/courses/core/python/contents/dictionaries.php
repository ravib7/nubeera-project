...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">Python Dictionaries</h1>
	...
	<div class="container">
		<h3>Dictionary</h3>
		Dictionaries are used to store data values in key:value pairs.<br><br>
		A dictionary is a collection which is ordered*, changeable and does not allow duplicates.<br><br>
		...
		Dictionary items are ordered, changeable, and do not allow duplicates.<br><br>
		...
		As of Python version 3.7, dictionaries are ordered. In Python 3.6 and earlier, dictionaries are unordered.<br><br>
		When we say that dictionaries are ordered, it means that the items have a defined order, and that order will not change.<br><br>
		Unordered means that the item does not have a defined order, you cannot refer to an item by using an index.<br>

		<h3>Changeable</h3>
		Dictionaries are changeable, meaning that we can change, add or remove items after the dictionary has been created.<br>

		<h3>Duplicates Not Allowed</h3>
		Dictionaries cannot have two items with the same key<br>
		<h3>Dictionary Length</h3>
		To determine how many items a dictionary has, use the <code>len() </code>function<br><br>
		...
		The <code>update()</code> method will update the dictionary with the items from the given argument.<br><br>
		The argument must be a dictionary, or an iterable object with key:value pairs.<br><br>
		The <code>popitem()</code> method removes the last inserted item (in versions before 3.7, a random item is removed instead)<br><br>
