...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">While-Loop in Python</h1>
	...
	<div class="container">
		<h3>Python Loops</h3>
		Python has two primitive loop commands:<br><br>
		<li><code>while</code> loops</li>
		<li><code>for</code> loops</li><br>
		<h4>The while Loop</h4>
		With the <code>while</code> loop we can execute a set of statements as long as a condition is true.<br><br>
		The <code>while</code> loop requires relevant variables to be ready, in this example we need to define an indexing variable, i, which we set to 1.<br>
		...
		With the <code>else</code> statement we can run a block of code once when the condition no longer is true<br>
