...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">Python Arrays</h1>
	...
	<div class="container">
		<h3>Arrays</h3>
		Note: This page shows you how to use LISTS as ARRAYS, however, to work with arrays in Python you will have to import a library, like the NumPy library.<br><br>
		Arrays are used to store multiple values in one single variable

		<h3>What is an Array?</h3>
		An array is a special variable, which can hold more than one value at a time.<br><br>
		If you have a list of items (a list of car names, for example), storing the cars in single variables could look like this:<br><br>
		<pre>car1 = "Ford"
car2 = "Volvo"
car3 = "BMW"</pre><br>
		...
		You refer to an array element by referring to the <i>index number</i>.

		<h3>The Length of an Array</h3>
		Use the len() method to return the length of an array (the number of elements in an array).

		<h3>Looping Array Elements</h3>
		You can use the for in loop to loop through all the elements of an array.

		<h3>Adding Array Elements</h3>
		You can use the append() method to add an element to an array.

		<h3>Removing Array Elements</h3>
