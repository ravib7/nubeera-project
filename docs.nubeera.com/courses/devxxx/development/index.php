...
<body>
    ...
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
        ...
        <div class="container">
            <h1 class="page-heading single-col-max mx-auto">Development</h1>
                            ...
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    <span class="theme-icon-holder card-icon-holder mr-2">
                                        <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">W </span>
                                    <!--//card-icon-holder-->
                                    <span class="card-title-text">Web</span>
                                </h5>
                                <div class="card-text">
                                    Web - All technologies for web development
                                </div>
                                <a class="card-link-mask" href="web/index.php"></a>
                            </div>
                            <!--//card-body-->
                        </div>
                        <!--//card-->
