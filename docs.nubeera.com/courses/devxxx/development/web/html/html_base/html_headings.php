...
<body>
    ...
    <div class="content-box" id="content-box">
        <div class="body-content">
            <h1 class="py-2 px-5 mb-0 heading" style="background: #33A4FF; color: white;">HTML Headings</h2>
                ...
                <div class="px-5 pb-5 pt-0 body-text">
                    <h2 id="html_basic">HTML Headings</h2>
                    <!-- <content> -->
                    ...
                    <code>&lth1></code> defines the most important heading. <code>&lth6></code> defines the least important heading.
                    ...
                    <h3 id="Headings Are Important" class="heading-anchor">Headings Are Important</h3>
                    ...
                    <code>&lth1></code> headings should be used for main headings, followed by <code>&lth2></code> headings, then the less important <code>&lth3></code>, and so on.

                    <br><br>
                    <div class="notes">
                        <strong>Note:</strong> Use HTML headings for headings only. Don't use headings to make text <strong>BIG</strong> or <strong>bold</strong>.
                    </div>

                    <h3 id="Bigger Headings" class="heading-anchor">Bigger Headings</h3>
                    ...
                    <div class="w3-example" style="border:2px;background-color:#D6EEEE;border-radius: 25px;padding: 10px;">
                        ...
                        <div class="w3-code notranslate htmlHigh" style="border:2px;background-color:#e6e6e6;padding: 10px;">
                            &lt;h1
                            style=&quot;font-size:60px;&quot;&gt;Heading 1&lt;/h1&gt;<br>
                        </div>
                    </div> <br>
