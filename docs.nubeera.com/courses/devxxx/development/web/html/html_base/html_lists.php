...
<body>
    ...
    <div class="content-box" id="content-box">
        <div class="body-content">
            <h1 class="py-2 px-5 mb-0 heading" style="background: #33A4FF; color: white;">HTML Lists</h2>
                ...
                <div class="px-5 pb-5 pt-0 body-text">
                    <!-- <content> -->
                    <hr>HTML lists allow web developers to group a set of related items in lists.
                    <hr>
                    ...
                    <h3 id="Unordered HTML List" class="heading-anchor">Unordered HTML List</h3>
                    An unordered list starts with the <code class="w3-codespan">&lt;ul&gt;</code> tag. Each list item starts with the
                    <code class="w3-codespan">&lt;li&gt;</code> tag.<br>
                    ...
                    <h3 id="Ordered HTML List" class="heading-anchor">Ordered HTML List</h3>
                    An ordered list starts with the <code class="w3-codespan">&lt;ol&gt;</code> tag. Each list item starts with the <code class="w3-codespan">&lt;li&gt;</code> tag.<br>
                    ...
                    <h3 id="HTML Description Lists" class="heading-anchor">HTML Description Lists</h3>
                    HTML also supports description lists.<br>
                    A description list is a list of terms, with a description of each term.<br>
                    The <code class="w3-codespan">&lt;dl&gt;</code> tag defines the description list, the <code class="w3-codespan">&lt;dt&gt;</code> tag defines the term (name), and the <code class="w3-codespan">&lt;dd&gt;</code>
                    tag describes each term:<br>
