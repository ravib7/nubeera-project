...
<body>
    ...
    <div class="content-box" id="content-box">
        <div class="body-content">
            <h1 class="py-2 px-5 mb-0 heading" style="background: #33A4FF; color: white;">HTML Comments</h2>
                ...
                <div class="px-5 pb-5 pt-0 body-text">
                    <!-- <content> -->
                    <hr>HTML comments are not displayed in the browser, but they can help document your HTML source code.
                    <hr>

                    <h3 id="HTML Comment Tag" class="heading-anchor">HTML Comment Tag</h3>
                    ...
                    Notice that there is an exclamation point (!) in the start tag, but not in the end tag.<br><br>
                    <div class="notes">
                        <strong>Note:</strong> Comments are not displayed by the browser, but they can help document your HTML source code.
                    </div>

                    <h3 id="Add Comments" class="heading-anchor">Add Comments</h3>
                    ...
                    <div class="w3-example" style="border:2px;background-color:#D6EEEE;border-radius: 25px;padding: 10px;">
                        ...
                        <div class="w3-code notranslate htmlHigh" style="border:2px;background-color:#e6e6e6;padding: 10px;">
                            ...
                            <br>&lt;!-- Remember to add more information here --&gt;
                        </div>
                    </div><br>


                    <h3 id="Hide Content" class="heading-anchor">Hide Content</h3>
                    Comments can be used to hide content.<br>

                    Which can be helpful if you hide content temporarily:<br>
                    <div class="w3-example" style="border:2px;background-color:#D6EEEE;border-radius: 25px;padding: 10px;">
                        <h3>Example</h3>
                        <div class="w3-code notranslate htmlHigh" style="border:2px;background-color:#e6e6e6;padding: 10px;">
                            &lt;p&gt;This is a paragraph.&lt;/p&gt;<br><br>&lt;!-- &lt;p&gt;This is another paragraph
                            &lt;/p&gt; --&gt;<br><br>&lt;p&gt;This is a paragraph too.&lt;/p&gt;
                        </div>
                    </div>
                    You can also hide more than one line, everything between the
                    <!-- and the --> will be hidden from the display.<br>
                    <div class="w3-example" style="border:2px;background-color:#D6EEEE;border-radius: 25px;padding: 10px;">
                        <h3>Example</h3>
                        Hide a section of HTML code:
                        <div class="w3-code notranslate htmlHigh" style="border:2px;background-color:#e6e6e6;padding: 10px;">
                            &lt;p&gt;This is a paragraph.&lt;/p&gt;<br>&lt;!--<br>&lt;p&gt;Look at this cool
                            image:&lt;/p&gt;<br>
                            &lt;img border=&quot;0&quot; src=&quot;pic_trulli.jpg&quot;
                            alt=&quot;Trulli&quot;&gt;<br>--&gt;<br>&lt;p&gt;This is a paragraph too.&lt;/p&gt;
                        </div>
                    </div>
                    ...
                    <h3 id="Hide Inline Content" class="heading-anchor">Hide Inline Content</h3>
