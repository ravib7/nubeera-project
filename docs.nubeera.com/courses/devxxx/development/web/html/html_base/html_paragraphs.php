...
<body>
    ...
    <div class="content-box" id="content-box">
        <div class="body-content">
            <h1 class="py-2 px-5 mb-0 heading" style="background: #33A4FF; color: white;">HTML Paragraphs</h2>
                ...
                <div class="px-5 pb-5 pt-0 body-text">
                    <!-- <content> -->
                    <br>HTML headings are titles or subtitles that you want to display on a webpage.<br>

                    <h3 id="html_paragraphs">HTML Paragraphs</h3>

                    The HTML <code>&ltp></code> element defines a paragraph.<br>
                    ...
                    <h3 id="HTML Display" class="heading-anchor">HTML Display</h3>
                    ...
                    <h3 id="HTML Horizontal Rules" class="heading-anchor">HTML Horizontal Rules</h3>
                    The <code>&lthr></code> tag defines a thematic break in an HTML page, and is most often displayed as a horizontal rule.<br>

                    The <code>&lthr></code> element is used to separate content (or define a change) in an HTML page:
                    ...
                    The <code>&lthr></code> tag is an empty tag, which means that it has no end tag.



                    <h3 id="HTML Line Breaks" class="heading-anchor">HTML Line Breaks</h3>
                    The HTML <code>&ltbr></code> element defines a line break.<br>

                    Use <code>&ltbr></code> if you want a line break (a new line) without starting a new paragraph:<br>
                    <div class="w3-example" style="border:2px;background-color:#D6EEEE;border-radius: 25px;padding: 10px;">
                        <h3>Example</h3>
                        <div class="w3-code notranslate htmlHigh" style="border:2px;background-color:#e6e6e6;padding: 10px;">
                    ...
                    The <code>&ltbr></code> tag is an empty tag, which means that it has no end tag.


                    <h3 id="HTML <pre> Element" class="heading-anchor">HTML <code>&ltpre></code> Element</h3>
                    The HTML <code>&ltbr></code> element defines a line break.<br>
