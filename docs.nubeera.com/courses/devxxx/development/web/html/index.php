...
<body>
    ...
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
        ...
        <div class="container">
            <h1 class="page-heading single-col-max mx-auto">HTML</h1>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    ...
                                    <!--//card-icon-holder-->
                                    <span class="card-title-text">HTML Basics</span>
                                </h5>
                                <div class="card-text">
                                    Basics of CSS
                                </div>
                                <div id="contact-popup">
                                    <a class="card-link-mask" href="html_base/"></a>
                                </div>
                            </div>
                            <!--//card-body-->
                        </div>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    ...
                                    <!--//card-icon-holder-->
                                    <span class="card-title-text">HTML Advanced</span>
                                </h5>
                                <div class="card-text">
                                    HTML Advanced
                                </div>
                                <div id="contact-popup">
                                    <a class="card-link-mask" href="html_advanced/"></a>
                                </div>
                            </div>
                            <!--//card-body-->
                        </div>
