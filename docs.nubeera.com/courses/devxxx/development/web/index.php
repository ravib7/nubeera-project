...
<body>
    ...
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
        ...
        <div class="container">
            <h1 class="page-heading single-col-max mx-auto">Web</h1>
                            ...
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    <span class="theme-icon-holder card-icon-holder mr-2">
                                        <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">H </span>
                                    <!--//card-icon-holder-->
                                ...
                                <a class="card-link-mask" href="html/index.php"></a>
                            </div>
                            <!--//card-body-->
                        </div>
                        <!--//card-->
                    ...
                    <div class="col-12 col-lg-4 py-3">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    <span class="theme-icon-holder card-icon-holder mr-2">
                                        <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">C </span>
                                    <!--//card-icon-holder-->
                                    <span class="card-title-text">CSS</span>
                                </h5>
                                <div class="card-text">
                                    For enhancing the webpage
                                </div>
                                <a class="card-link-mask" href="css/index.php"></a>
                            </div>
                            <!--//card-body-->
                        </div>
                        <!--//card-->
