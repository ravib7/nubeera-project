...
<body>
    ...
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
        ...
        <div class="container">
            <h1 class="page-heading single-col-max mx-auto">SysOps</h1>
    ...
    <ul class="breadcrumb">
        ...
        <li> <a href="../index.php">DevOps</a></li>
        <li>SysOps</li>
    </ul>
							...
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-2">
										<img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">T </span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Terraform</span>
								</h5>
								<div class="card-text">
                                    A powerful tool for developers
								</div>
								<a class="card-link-mask" href="terraform/index.php"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
