...
<body>
    ...
    <div class="content-box" id="content-box">
        <div class="body-content">
            <h1 class="py-2 px-5 mb-0 heading" style="background: #33A4FF; color: white;">LAB 9</h1>
            ...
            <div class="px-5 pb-5 pt-0 body-text">
                ...
                <ul class="toc__menu">
                    ...
                    <li><a href="#end-of-lab-9">End of Lab 9</a></li>
                </ul>
                </nav>
                </aside>
                ...
                In this lab we will look at provisioners, and how they can be used to drive additional virtual machine customisation once the base image has been deployed. <br><br>
                ...
                <h3 id="end-of-lab-9">End of Lab 9</h3>

                We have reached the end of the lab. You have use provisioners and templates to demonstrate how you could direc additional configuration in your virtual machines once they have been deployed from a template. <br><br>

                Your .tf files should look similar to those in <a href="https://github.com/richeney/terraform-pre-012-lab9">https://github.com/richeney/terraform-pre-012-lab9</a>. <br><br>
