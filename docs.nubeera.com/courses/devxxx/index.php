...
<body>
    ...
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
        ...
        <div class="container">
            <h1 class="page-heading single-col-max mx-auto">DevOps</h1>
						...
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									...
									<!--//card-icon-holder-->
									<span class="card-title-text">SysOps</span>
								</h5>
								<div class="card-text">
                                    SysOps - System and Operations
								</div>
								<a class="card-link-mask" href="sysops/index.php"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
						...
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									...
									<!--//card-icon-holder-->
									<span class="card-title-text">Development</span>
								</h5>
								<div class="card-text">
                                    All Web Development Technologies 
								</div>
								<a class="card-link-mask" href="development/index.php"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
