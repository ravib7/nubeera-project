...
<head>
    <title>NubeEra CloudOps</title>

    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="NubeEra CloudOps">
...
<body>
    ...
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
        ...
        <div class="container">
            <h1 class="page-heading single-col-max mx-auto">CloudOps</h1>
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    ...
                                    <span class="card-title-text">Boto3</span>
                                </h5>
                                <div class="card-text">
                                    Boto3 contents
                                </div>
                                <div id="contact-popup">
                                    <a class="card-link-mask" href="boto3/"></a>
                                </div>
                            </div>
                            <!--//card-body-->
                        </div>
                    ...
                    <div class="col-12 col-lg-4 py-3" hidden>
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    <span class="theme-icon-holder card-icon-holder mr-2">2.</span>
                                    <!--//card-icon-holder-->
                                    <span class="card-title-text">Azure DevOps</span>
                                </h5>
                                <div class="card-text">
                                    Azure DevOps Contents
                                </div>
                                <div id="contact-popup">
                                    <a class="card-link-mask" href="az_devops/"></a>
                                </div>
                            </div>
                            <!--//card-body-->
                        </div>
