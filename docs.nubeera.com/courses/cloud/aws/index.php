...
<head>
	<title>NubeEra Cloud Computing</title>

	<!-- Meta -->
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="NubeEra Cloud Computing">
...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">Amazon Web Services</h1>
			...
			<div class="main-search-box pt-3 d-block mx-auto">
				<form class="search-form w-100" autocomplete="chrome-off">
					<input type="text" autocomplete="chrome-off" id="searchbarbox" onkeyup="showresults()" placeholder="Search..." name="search" class="form-control search-input">
							...
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-2">
										<img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">P </span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Presentations</span>
								</h5>
								<div class="card-text">
									Topic-wise easy to understand presentations
								</div>
							...
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
										<img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">C
									</span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Contents</span>
								</h5>
								<div class="card-text">
								Topic-wise easy to understand contents
								</div>
								<a class="card-link-mask" href="contents/"></a>
							</div>
							<!--//card-body-->
						</div>
						<!--//card-->
               ...
               <div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-1">
                              <img class="svg-inline--fa" style="width:auto" src="" class="svg-inline--fa">QnA</span>
									<!--//card-icon-holder-->
									<span class="card-title-text">Interview QnA</span>
								</h5>
								<div class="card-text">
