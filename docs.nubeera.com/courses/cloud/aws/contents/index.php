...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			<h1 class="page-heading single-col-max mx-auto">Amazon Web Services Contents</h1>
							...
							<div class="card-body">
								<h5 class="card-title mb-3">
									<span class="theme-icon-holder card-icon-holder mr-2">
										<img src="https://www.cleo.com/sites/default/files/2019-06/azure-half.png" style="width:auto" class="svg-inline--fa">
									</span>
									<!--//card-icon-holder-->
								...
								<div id="contact-popup">
									<a class="card-link-mask" href="topics/storage_blob/"></a>
								</div>
							</div>
							<!--//card-body-->
						</div>
